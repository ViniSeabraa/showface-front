        ...
        <form noValidate onSubmit={handleSubmit}>
          ...
          <div className="album-upload-container">
            ...
            >
              ...
              <span className="small-font">Seu álbum de fotos</span>
            </button>
            <div className="album-text">
              Mande as fotos do seu álbum em um arquivo .zip (compactado)
            </div>
          </div>
          ...
          <button className="button-confirm mt-8 mb-8" type="submit">
            + Criar Evento
          </button>
        </form>
      </div>
